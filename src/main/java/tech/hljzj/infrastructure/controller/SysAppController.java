...
public class SysAppController extends BaseController {
    ...
    public R<SysAppDetailVo> entityGet(@PathVariable Serializable id) {
        SysApp dto = this.service.entityGet(id);
        return R.ok(new SysAppDetailVo().fromDto(dto));
    }
    ...
    @PostMapping("/insert")
    public R<SysAppDetailVo> entityCreate(@RequestBody @Validated SysAppNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysAppDetailVo> entityUpdate(@RequestBody @Validated SysAppUpdateVo entity) {
        SysApp dto = entity.toDto();
