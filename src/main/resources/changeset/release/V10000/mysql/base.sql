...
CREATE TABLE IF NOT EXISTS `sys_dict_type_`  (
  `id_` char(32)  NOT NULL,
  `owner_app_id_` char(128)  COMMENT '所属应用标识',
  `key_` varchar(255)  COMMENT '字典类型标识',
...
CREATE TABLE IF NOT EXISTS `sys_menu_`  (
  ...
  `key_` varchar(255)  COMMENT '菜单标识，权限标识',
