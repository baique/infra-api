...
/**
 * 当流程开始时，what are you want to do
 */
public class ProcessStartMonitor extends TaskCompleteMonitor implements ExecutionListener {
    @Override
    public void notify(DelegateExecution execution) {
        ...
        manager.onProcessStart(processInstanceBusinessKey);
    }
}
