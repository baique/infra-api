...
public class SysDeptController extends BaseController {
    ...
    public R<SysDept> entityGet(@PathVariable Serializable id) {
    ...
    @PostMapping("/insert")
    public R<SysDept> entityCreate(@RequestBody @Validated SysDeptNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysDept> entityUpdate(@RequestBody @Validated SysDeptUpdateVo entity) {
        SysDept dto = entity.toDto();
