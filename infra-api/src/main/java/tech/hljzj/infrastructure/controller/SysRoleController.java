...
import tech.hljzj.infrastructure.vo.SysRole.SysRoleNewVo;
import tech.hljzj.infrastructure.vo.SysRole.SysRoleQueryVo;
import tech.hljzj.infrastructure.vo.SysRole.SysRoleUpdateVo;
...
public class SysRoleController extends BaseController {
    ...
    public R<SysRole> entityGet(@PathVariable Serializable id) {
    ...
    @PostMapping("/insert")
    public R<SysRole> entityCreate(@RequestBody @Validated SysRoleNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysRole> entityUpdate(@RequestBody @Validated SysRoleUpdateVo entity) {
        SysRole dto = entity.toDto();
    ...
    public R<List<ExcelUtil.FailRowWrap<SysRoleListVo>>> importData(@RequestPart MultipartFile file) throws IOException {
        return R.ok(ExcelUtil.readExcel(file.getInputStream(), SysRoleListVo.class, SysRoleListVo -> {
