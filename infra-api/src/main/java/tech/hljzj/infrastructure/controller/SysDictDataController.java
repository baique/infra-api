...
import tech.hljzj.infrastructure.vo.SysDictData.SysDictDataNewVo;
import tech.hljzj.infrastructure.vo.SysDictData.SysDictDataQueryVo;
import tech.hljzj.infrastructure.vo.SysDictData.SysDictDataUpdateVo;
...
public class SysDictDataController extends BaseController {
    ...
    public R<SysDictData> entityGet(@PathVariable Serializable id) {
    ...
    @PostMapping("/insert")
    public R<SysDictData> entityCreate(@RequestBody @Validated SysDictDataNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysDictData> entityUpdate(@RequestBody @Validated SysDictDataUpdateVo entity) {
        SysDictData dto = entity.toDto();
    ...
    public R<List<ExcelUtil.FailRowWrap<SysDictDataListVo>>> importData(@RequestPart MultipartFile file) throws IOException {
        return R.ok(ExcelUtil.readExcel(file.getInputStream(), SysDictDataListVo.class, SysDictDataListVo -> {
