...
import tech.hljzj.infrastructure.vo.SysUser.SysUserNewVo;
import tech.hljzj.infrastructure.vo.SysUser.SysUserUpdateVo;
...
public class SysUserController extends BaseController {
    ...
    public R<SysUser> entityGet(@PathVariable Serializable id, Boolean fetchExtAttr) {
        return R.ok(this.service.entityGet(id, ObjUtil.defaultIfNull(fetchExtAttr, false)));
    }
    ...
    @PostMapping("/insert")
    public R<SysUser> entityCreate(@RequestBody @Validated SysUserNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysUser> entityUpdate(@RequestBody @Validated SysUserUpdateVo entity) {
        SysUser dto = entity.toDto();
    ...
    public R<List<ExcelUtil.FailRowWrap<SysUserListVo>>> importData(@RequestPart MultipartFile file) throws IOException {
        return R.ok(ExcelUtil.readExcel(file.getInputStream(), SysUserListVo.class, SysUserListVo -> {
