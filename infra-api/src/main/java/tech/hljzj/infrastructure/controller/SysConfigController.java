...
import tech.hljzj.infrastructure.vo.SysConfig.SysConfigListVo;
import tech.hljzj.infrastructure.vo.SysConfig.SysConfigNewVo;
import tech.hljzj.infrastructure.vo.SysConfig.SysConfigQueryVo;
import tech.hljzj.infrastructure.vo.SysConfig.SysConfigUpdateVo;
...
public class SysConfigController extends BaseController {
    ...
    public R<SysConfig> entityGet(@PathVariable Serializable id) {
    ...
    @PostMapping("/insert")
    public R<SysConfig> entityCreate(@RequestBody @Validated SysConfigNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysConfig> entityUpdate(@RequestBody @Validated SysConfigUpdateVo entity) {
        SysConfig dto = entity.toDto();
