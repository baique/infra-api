...
import tech.hljzj.infrastructure.vo.SysMenu.SysMenuNewVo;
import tech.hljzj.infrastructure.vo.SysMenu.SysMenuQueryVo;
import tech.hljzj.infrastructure.vo.SysMenu.SysMenuUpdateVo;
...
public class SysMenuController extends BaseController {
     ...
     * @return 数据详情
     */
    @PreAuthorize("auth('sys:menu:query')")
    @GetMapping("/{id}")
    public R<SysMenu> entityGet(@PathVariable Serializable id) {
    ...
    @PostMapping("/insert")
    public R<?> entityCreate(@RequestBody @Validated SysMenuNewVo entity) {
    ...
    @PostMapping("/update")
    public R<SysMenu> entityUpdate(@RequestBody @Validated SysMenuUpdateVo entity) {
        SysMenu dto = entity.toDto();
    ...
    public R<List<ExcelUtil.FailRowWrap<SysMenuListVo>>> importData(@RequestPart MultipartFile file) throws IOException {
        return R.ok(ExcelUtil.readExcel(file.getInputStream(), SysMenuListVo.class, SysMenuListVo -> {
