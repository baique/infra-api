...
@Getter
@Setter
public class SysActivitiQueryBaseVo<T extends SysActiviti> extends PageDomain implements Serializable {
    ...
    public Consumer<LambdaQueryWrapper<? extends T>> conditionId() {
        return (builder)->{
          ...
          builder.eq(StrUtil.isNotBlank(this.getId()),SysActiviti::getId, StrUtil.trim(this.getId()));
    ...
    public Consumer<LambdaQueryWrapper<? extends T>> conditionKey() {
        return (builder)->{
          ...
          builder.eq(StrUtil.isNotBlank(this.getKey()),SysActiviti::getKey, StrUtil.trim(this.getKey()));
    ...
    public Consumer<LambdaQueryWrapper<? extends T>> conditionName() {
        return (builder)->{
          ...
          builder.eq(StrUtil.isNotBlank(this.getName()),SysActiviti::getName, StrUtil.trim(this.getName()));
    ...
    public Consumer<LambdaQueryWrapper<? extends T>> conditionStatus() {
        return (builder)->{
          ...
          builder.eq(StrUtil.isNotBlank(this.getStatus()),SysActiviti::getStatus, StrUtil.trim(this.getStatus()));
    ...
    public Consumer<LambdaQueryWrapper<? extends T>> conditionSort() {
        return (builder)->{
          ...
          builder.eq( null != this.getSort(),SysActiviti::getSort, (this.getSort()));
    ...
    public Consumer<LambdaQueryWrapper<? extends T>> conditionDesc() {
        return (builder)->{
          ...
          builder.eq(StrUtil.isNotBlank(this.getDesc()),SysActiviti::getDesc, StrUtil.trim(this.getDesc()));
